...
import { SiDiscord, SiGithub, SiLinkedin, SiTiktok, SiTwitter, SiYoutube } from 'react-icons/si';
...
const HeaderBlock: React.FC = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    <h1 className="mb-12 text-4xl font-medium leading-tight">
      Hi, I'm Tom. <span className="text-zinc-400">I build cool websites like this one.</span>
    </h1>
  ...
  <Block className="col-span-12 text-3xl leading-snug">
    <p>
      ...
      <span className="text-zinc-400">
        I build primarily with React, Tailwind CSS, and Framer Motion. I love this stack so much that I even built a
        website about it. I've made over a hundred videos on the subject across YouTube and TikTok.
      </span>
    </p>
  </Block>
);
